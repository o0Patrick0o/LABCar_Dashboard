...
export const VField = genericComponent()({
  ...
  setup(props, { attrs, emit, slots }) {
    ...
    const hasLabel = computed(
      () => !props.singleLine && !!(props.label || slots.label)
    )
        ...
        if (hasLabel.value) {
          ...
          requestAnimationFrame(() => {
            ...
            const scale = parseFloat(
              targetStyle.getPropertyValue("--v-field-label-scale")
            )
        ...
        >
          ...
          {hasClear && (
            <VExpandXTransition key="clear">
              ...
              >
                {slots.clear ? slots.clear() : <InputIcon name="clear" />}
              </div>
            </VExpandXTransition>
          )}
...
export function filterFieldProps(attrs) {
  const keys = Object.keys(VField.props).filter(
    k => !isOn(k) && k !== "class" && k !== "style"
  )
