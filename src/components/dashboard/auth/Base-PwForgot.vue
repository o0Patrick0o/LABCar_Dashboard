<template>
  <div class="w-full ">
    <div class="flex shadow rounded-md">
      <div class="bg-white dark:bg-gray-90 w-2/5 lg:block hidden"></div>
      
      <div class="bg-white dark:bg-gray-900 w-full">
        <form>
          <div class="form-body lg:max-w-xl mx-auto lg:p-10 p-8 lg:mt-20 mt-5 space-y-8">
            ...
            <p class="dark:text-white text-center text-gray-700">
              ...
              <button type="button" @click="$router.push('/auth/login')" class="ml-2 text-primary">
                Login here
              </button>
            </p>
          </div>
