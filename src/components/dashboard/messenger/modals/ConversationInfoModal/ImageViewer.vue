      ...
      <div v-show="open" class="fixed inset-0 z-10 overflow-y-auto">
        <div class="h-full flex flex-col p-5">
          ...
          <div class="w-full flex justify-end">
            <button @click="closeImage" class="rounded-full p-2 hover:bg-white hover:bg-opacity-10 active:bg-opacity-20 transition-all duration-200" aria-label="previous item">
              <font-awesome-icon icon="fa-solid fa-xmark" class="w-7 h-7 text-white stroke-1"/>
            </button>
          </div>
