<template>
  <div class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-xl border border-gray-300 rounded ">
    <div class="px-5 pt-5">
...
<script>
import { ref } from 'vue'
import LineChart from '@/components/dashboard/charts/LineChart01.vue'
