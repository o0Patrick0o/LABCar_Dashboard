<template>
  <div class="wrapper-steppy" :style="cssVars">
    ...
    <div class="steppy">
      ...
      <div class="steppy-item" :class="{ current: props.step === index + 1, success: props.step > index + 1, }" v-for="(item, index) in tabs" :key="index">
    ...
    <div class="controls">
      ...
      <button class="btn" type="button" @click="decrementStep" v-if="props.step !== 1">
        {{ props.backText }}
      </button>
      
      <button class="btn btn--default-2" type="button" @click="incrementStep" v-if="props.step !== props.tabs.length" :disabled="!props.tabs[props.step - 1].isValid">
        {{ props.nextText }}
      </button>
      
      <button class="btn btn--default-2" type="button" @click="finalize" v-else :disabled="!props.tabs[props.step - 1].isValid || loading">
