<template>
  <div class="md-file">
    <md-file-icon class="md-file-icon" :class="{'md-disabled': this.disabled}" @click.native="openPicker" />

    <input class="md-input" readonly v-model="model" v-bind="{ disabled, required, placeholder }" @click="openPicker"  @blur="onBlur">
...
<script>
  ...
  import MdFieldMixin from '@/components/base/field/MdFieldMixin'
